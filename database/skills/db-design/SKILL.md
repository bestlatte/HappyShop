...
name: db-design
description: >
  Guide HappyShop DB v1 schema design based on current frontend implementation,
  backend feature drafts, database rules, and documented feature-to-data
  requirements. Use when designing tables, defining relationships, reviewing ERD,
  generating MySQL 8.0.46 DDL, or discussing HappyShop database modeling.
---
...
具體 DB v1 候選表、待確認表與 optional/future 清單，應以 `docs/full-system-functional-data-requirements.md` 的最新版本為主要參考。
